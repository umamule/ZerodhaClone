...
function Footer() {
    return ( 
        <div className='container border-top mt-5 p-5' style={{backgroundColor:"rgb(250,250,250)"}}>
            <div className='row mb-5'>
                <div className='col'>
                    <img src='media/images/logo.svg' style={{width:"50%"}}/>
                    <p>© 2010 - 2024, Zerodha Broking Ltd.<br/>All rights reserved.</p>
                    <div className='row'>
                        <div className='col'><i class="fa fa-twitter-square" aria-hidden="true"></i>
                        </div>
                        <div className='col'><i class="fa fa-facebook-official" aria-hidden="true"></i></div>
                        <div className='col'><i class="fa fa-instagram" aria-hidden="true"></i>
                        </div>
                        <div className='col'><i class="fa fa-linkedin" aria-hidden="true"></i>
                        </div>
                        <hr className='mt-3' style={{width:"90%"}}/>
                    </div>
                    <div className='row'>
                        <div className='col'><i class="fa fa-youtube-play" aria-hidden="true"></i>
                        </div>
                        <div className='col'><i class="fa fa-whatsapp" aria-hidden="true"></i>
                        </div>
                        <div className='col'><i class="fa fa-telegram" aria-hidden="true"></i>
                        </div>
                        <div className='col'>
                        </div>
                    </div>
